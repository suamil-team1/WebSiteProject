...
@WebServlet("/adminpage/Delete.do")
public class Adm_DeleteController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) 
		...
		if(result == 1) {
			...
			JSFunction.alertLocation(resp, "해당 게시물이 삭제되었습니다.", "../adminpage/CheckIn.do?boardName="+boardName);
