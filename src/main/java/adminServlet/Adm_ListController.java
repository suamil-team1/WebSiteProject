...
import util.BoardPage2;

@WebServlet("/adminpage/board2_list.do")
public class Adm_ListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) 
		...
		//페이지 번호 생성
		String pagingImg = BoardPage2.pagingStr(totalCount, pageSize, blockPage, pageNum, 
				"../adminpage/Adm_ListController.do?boardName="+boardName, map);
		...
		if(boardName.equals("emp"))
			req.getRequestDispatcher("/adminpage/board2_list.jsp").forward(req, resp);
