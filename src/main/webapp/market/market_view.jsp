			...
			<div class="right_contents">
				...
				<div class="market_view_box">
					...
					<div class="market_right">
						...
						<p class="btn_box"><a href="basket02.jsp?idx=<%= dto.getIdx()%>"><img src="../images/market/m_btn01.gif" alt="바로구매" /></a>&nbsp;&nbsp;<a href="basket.jsp?idx=<%= dto.getIdx()%>"><img src="../images/market/m_btn02.gif" alt="장바구니" /></a></p>
					</div>
				</div>
