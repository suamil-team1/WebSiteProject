...
<script>
	...
	function setDomain(domain) {
		var selectDomain = document.getElementById('last_email_check2');	
		
        for (i=0; i<selectDomain.length; i++) {
            if (selectDomain.options[i].value == domain)  {
            	selectDomain.options[i].selected = true; // 같은경우라면 체크되도록 한다.
                break;
            }
        }
	} 
