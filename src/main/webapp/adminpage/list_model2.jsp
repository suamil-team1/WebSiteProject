		...
		<c:choose>
			...
			<c:otherwise> <!-- 출력할 게시물이 있을때 -->
		        ...
		        <tr align="center">
		            <td>${row.idx}</td> 
		            <td align="left">	<!-- 제목 -->
		                <a href="../adminpage/View.do?boardName=${row.boardName}&idx=${row.idx}">${row.title}</a>
		            </td>
...
<div style="text-align:right;">
	<!-- 각종 버튼 부분 -->		
	<button type="button" onclick="location.href='Write.do?boardName=${param.boardName}';">글쓰기</button>
</div>                                                    
<div>
	${map.pagingImg}
</div>
