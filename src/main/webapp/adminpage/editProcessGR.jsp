...
try{
	...
	if(affected==1){//성공
		...
		switch(boardName){
		case "gal" :
			response.sendRedirect("gallery_list.jsp?idx="+ dto.getIdx() +"&boardName=" + dto.getBoardName());	
			return;
		case "ref" :
			response.sendRedirect("board_list03.jsp?idx="+ dto.getIdx() +"&boardName=" + dto.getBoardName());	
			return;
		}
	}
}
